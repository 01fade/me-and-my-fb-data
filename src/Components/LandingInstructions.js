    ...
    render() {
        return (
          <div>
            ...
            <p><i>Unzip.</i></p>
            <p>Find the <i>"html" folder</i> in your download. Then upload the files <i>"security.htm"</i> and <i>"messages.htm"</i> here. They will mainly be process here in your browser. This takes a minute or two.</p>
